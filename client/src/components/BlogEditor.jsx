...
export default function BlogEditor({ content: initialContent, formData: initialFormData }) {
    ...
    const isChanged = () => {
        if (!initialFormData) return true; // new blog 
        return (
            formData.title.trim() !== initialFormData.title.trim() ||
            formData.base64Img !== initialFormData.base64Img ||
            formData.selectedTopics !== initialFormData.selectedTopics ||
    ...
    return (
        <>
            <header className="fixed flex justify-between h-15 items-center border-b bg-amber-300 dark:bg-[#130f00] border-base-300 w-full top-0 z-50 backdrop-blur-lg">
                <Link to={initialFormData ? `/blog/${initialFormData.slug}` : "/dashboard"} className="flex gap-1.5 px-5 m-0">
                <ChevronLeft />
                <p>Back</p>
                </Link>
                ...
                <button
                    ...
                    disabled={!isChanged() || isSavingBlog}
            ...
            <div className="pt-20">
            <h1 className="text-xl text-center font-semibold py-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 p-8 gap-4">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="sm:col-span-2">
                        ...
                        <input
                            ...
                            className="input block w-full rounded-md border-0 py-2 px-4 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 dark:placeholder:text-gray-300 sm:text-sm sm:leading-6"
                    ...
                    {/* Cover Image */}
                    <div className="sm:col-span-2">
                        <p className="block text-sm font-medium leading-6 mb-2 cursor-default">Cover Image</p>
                        <label
                        htmlFor="cover-image"
                        >                    
                    ...
                    <div className="sm:col-span-2">
                        ...
                        <select
                            ...
                            className={`select ${"block w-full rounded-md border-0 py-2 px-4 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400  sm:text-sm sm:leading-6"}`}
                    ...
                    <div className="sm:col-span-2">
                        ...
                        <div className="w-1xl h-5xl">
                            ...
                            <div id="toolbar" className="dark:text-gray-100 text-gray-800"/>
                        </div>
                    </div>
                    {/* Tags */}
                ...
                <div className="grid gap-4 sm:grid-cols-2 sm:gap-6">
                    {/* Title */}
                    <div className="sm:col-span-2">
                        <h2 className="block text-sm font-medium leading-6 mb-2 text-gray-800 dark:text-gray-200 ">
                            Blog Title
                        </h2>
                        <div className="mt-2">
                    ...
                    {/* Slug */}
                    <div className="sm:col-span-2">
                        <h2 className="block text-sm font-medium leading-6 text-gray-900 dark:text-gray-200 mb-2">
                            Blog Image
                        </h2>
                        <div className="mt-2">
