...
import { ArrowLeft, Loader2, Lock, Mail, User, Verified } from "lucide-react";
...
export default function EmailVerificationPage() {
    ...
    const handleSubmit = (e) => {
        ...
        if (success === true) verifyEmail(formData);
    };

    const validateForm = () => {
        if (!formData.token.trim()) return toast.error("Token is required");
