import { Calendar, FileText, NotepadText } from "lucide-react";
  ...
  return (
    <div className="grid grid-cols-1 justify-center">
      ...
      <div className="flex flex-col px-4 my-0 py-4">
        <h3 className="font-semibold text-4xl mb-4">Elsa Calvin</h3>
        <div className="flex">
      ...
      <div className="flex flex-col px-4 my-0 py-4">
        <h3 className="text-2xl font-semibold flex gap-1.5 mb-2">Stories<p className="text-gray-500">(9)</p></h3>
