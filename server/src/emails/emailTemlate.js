export function createEmailTemplate(name, clientURL) {
  ...
  <body style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f5f5f5;">
    <div style="background: linear-gradient(to right, #7fa1a3, #253a69); padding: 30px; text-align: center; border-radius: 12px 12px 0 0;">
    ...
    <div style="background-color: #ffffff; padding: 35px; border-radius: 0 0 12px 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.05);">
      ...
      <p>We're excited to have you join our blog platform! GettySories keep you entertained, giving you the feeling of relief and joy, jump right in and change the world with your pen.</p>
      ...
      <div style="background-color: #f8f9fa; padding: 25px; border-radius: 10px; margin: 25px 0; border-left: 4px solid #36D1DC;">
        ...
        <ul style="padding-left: 20px; margin: 0;">
          ...
          <li style="margin-bottom: 10px;">Start writing</li>
          <li style="margin-bottom: 10px;">Start a conversation</li>
          <li style="margin-bottom: 0;">And watch the world see the legend in you</li>
        </ul>
      </div>
      ...
      <p style="margin-top: 0;">Happy writing!</p>
